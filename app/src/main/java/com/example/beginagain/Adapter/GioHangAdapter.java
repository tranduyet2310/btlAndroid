...
public class GioHangAdapter extends RecyclerView.Adapter<GioHangAdapter.ItemViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
        ...
        if(gioHang.getHinhanh().contains("http")){
            Glide.with(context).load(gioHang.getHinhanh())
                    .into(holder.item_giohang_image);
        }else{
            String img = Utils.BASE_URL+"images/"+gioHang.getHinhanh();
            Glide.with(context).load(img).into(holder.item_giohang_image);
        }
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private TextView item_giohang_tensp, item_giohang_gia, item_giohang_soluong, item_giohang_giasp2;
        private ImageView item_giohang_tru, item_giohang_cong, item_giohang_image;
        ...
        public void onClick(View view) {
            if(view == item_giohang_tru){
                listener.onImageClick(view, getAdapterPosition(), 1); // 1 là trừ
            }else if(view == item_giohang_cong){
                listener.onImageClick(view, getAdapterPosition(), 2); // 2 là cộng
            }
        }
    }
}
